...
/**
 * This is the model class which  is mapped to the database using the bday collection.This
 * class contains the members and their getter ,setter and constructors.
 *
 * @author Kopal Choure.
 */
...
public class Bday {
     ...
     */
    public Bday(String firstname, String lastname, String teamname, String associd, Integer day, String months, Integer year) {
